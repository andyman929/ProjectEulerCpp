...
void Obj::Project58Calc(int thresholdPC)
{
...
void Obj::Project58AddLayer(int *last, int layer, vector<int> *corn)
{
    for (int i = 0; i < 4; i++)
    {
        *last += layer * 2;
...
void Obj::Project58EraseConjugates(vector<int> *list, int oldSize)
{
