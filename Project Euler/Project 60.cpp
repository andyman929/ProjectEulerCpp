...
void ProjectsObj::Project60Calc4p()
{
...
void ProjectsObj::Project60Calc()
{
...
void ProjectsObj::Project60CalcNoMap()
{
    // Initialise sieve and prime list up to 25000
    Proj60Limit = LIMIT;
    Proj60ExtendSieve();
...
void ProjectsObj::Proj60ExtendSieve()
{
    int pos;
    int start;
    int restart;
...
bool ProjectsObj::Proj60IsPrime(int p)
{
...
bool ProjectsObj::Proj60CheckPrimes2(int p1, int p2)
{
    string testStr;
    __int64 testVal;
...
set<int> ProjectsObj::Proj60BuildPairs(int p)
{
    set<int> pairs;
    int index;
...
set<int> ProjectsObj::Proj60Intersect(set<int> s1, set<int> s2)
{
...
set<int> ProjectsObj::Proj60PairsSubset(int p, set<int> set1)
{
    set<int> intersect;
    for (int p2 : set1)
    {
